<div class="th-hero-wrapper hero-2" id="hero">
    <div class="slider-area">
                    ...
                    <div class="th-hero-slide">
                        ...
                        <div class="container">
                            <div class="hero-style2">
                                ...
                                <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s">SECURE & IT
                                    SERVICES</span>
                                ...
                                <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.9s">
                                    <a href="javascript:voic(0)" class="th-btn style3">
                                        DISCOBER MORE <i class="fa-regular fa-arrow-right ms-2"></i>
                                    </a>
                        ...
                        <div class="container">
                            <div class="hero-style2">
                                <div class="ripple-shape"><span class="ripple-1"></span><span
                                        class="ripple-2"></span><span class="ripple-3"></span><span
                                ...
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.7s">Energistically
                                    harness ubiquitous imperatives without state of the art collaboration and
                                    idea-sharing. Monotonectally parallel task cross-unit experiences and front-end.
                                </p>
                                <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.9s"><a
                                        href="javascript:voic(0)" class="th-btn style3">DISCOBER MORE<i
                                            class="fa-regular fa-arrow-right ms-2"></i></a> <a href="contact.html"
                                        class="th-btn style2">CONTACT US<i
                        ...
                        <div class="container">
                            <div class="hero-style2">
                                <div class="ripple-shape"><span class="ripple-1"></span><span
                                        ...
                                        class="ripple-6"></span></div><span class="hero-subtitle"
                                    data-ani="slideinleft" data-ani-delay="0.1s">SECURE & IT SERVICES</span>
                                <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.3s">Make The Easiest
                                </h1>
                                <h1 class="hero-title" data-ani="slideinleft" data-ani-delay="0.5s">Solution For You
                                </h1>
                                <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.7s">Energistically
                                    harness ubiquitous imperatives without state of the art collaboration and
                                    idea-sharing. Monotonectally parallel task cross-unit experiences and front-end.
        ...
        </div><button data-slider-prev="#heroSlider2" class="slider-arrow style3 slider-prev"><i
