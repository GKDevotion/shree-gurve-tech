<section class="bg-smoke" id="process-sec" data-bg-src="<?php echo $seoArr['base_url'].'assets/img/bg/process_bg_1.png';?>">
    <div class="container space">
        ...
        <div class="process-card-area">
            <div class="process-line">
                <img src="<?php echo $seoArr['base_url'].'assets/img/bg/process_line.svg';?>" alt="line">
            </div>
            <div class="row gy-40">
                <div class="col-sm-6 col-xl-3 process-card-wrap">
                    <div class="process-card">
                        ...
                        <div class="process-card_icon">
                            <img src="<?php echo $seoArr['base_url'].'assets/img/icon/process_card_1.svg';?>" alt="icon">
                        </div>
                ...
                <div class="col-sm-6 col-xl-3 process-card-wrap">
                    <div class="process-card">
                        ...
                        <div class="process-card_icon">
                            <img src="<?php echo $seoArr['base_url'].'assets/img/icon/process_card_2.svg';?>" alt="icon">
                        </div>
                ...
                <div class="col-sm-6 col-xl-3 process-card-wrap">
                    <div class="process-card">
                        ...
                        <div class="process-card_icon">
                            <img src="<?php echo $seoArr['base_url'].'assets/img/icon/process_card_3.svg';?>" alt="icon">
                        </div>
                ...
                <div class="col-sm-6 col-xl-3 process-card-wrap">
                    <div class="process-card">
                        ...
                        <div class="process-card_icon">
                            <img src="<?php echo $seoArr['base_url'].'assets/img/icon/process_card_4.svg';?>" alt="icon">
                        </div>
