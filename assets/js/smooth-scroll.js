!(function () {
    ...
    function m() {
        if (!c && document.body) {
            ...
            if (
                ...
                if (
                    ((f.style.cssText =
                        "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + s.scrollHeight + "px"),
                    ...
                    setTimeout(o, 10),
                    X("resize", o),
                    (t = new j(o)).observe(n, { attributes: !0, childList: !0, characterData: !1 }),
                    s.offsetHeight <= i)
                ) {
    ...
    function p(e, t, o) {
        ...
        if ((h.push({ x: t, y: o, lastX: t < 0 ? 0.99 : -0.99, lastY: o < 0 ? 0.99 : -0.99, start: Date.now() }), !w)) {
            var s = R(),
            ...
            var d = function (n) {
                ...
                u ? window.scrollBy(l, i) : (l && (e.scrollLeft += l), i && (e.scrollTop += i)),
                    t || o || (h = []),
                    h.length
                        ? $(d, e, 1e3 / a.frameRate + 1)
                        : ((w = !1),
                          null != e.$scrollBehavior &&
                              ((e.style.scrollBehavior = e.$scrollBehavior), (e.$scrollBehavior = null)));
            };
            $(d, e, 0), (w = !0);
        }
    }
    function y(t) {
        ...
        d &&
            (t.wheelDeltaX && N(t.wheelDeltaX, 120) && (r = (t.wheelDeltaX / Math.abs(t.wheelDeltaX)) * -120),
            t.wheelDeltaY && N(t.wheelDeltaY, 120) && (i = (t.wheelDeltaY / Math.abs(t.wheelDeltaY)) * -120)),
        ...
        return s
            ? !!(function (e) {
                  ...
                  t.preventDefault(),
                  void T())
            : !l || !_ || (Object.defineProperty(t, "target", { value: window.frameElement }), parent.wheel(t));
    }
    function b(t) {
        var o = t.target,
