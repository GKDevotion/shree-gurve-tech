                    ...
                    .each(function () {
                        e(this).on("click", function () {
                            ...
                            t.length &&
                                ...
                                e("html, body").stop().animate({ scrollTop: t.offset().top }, 1e3));
                        });
                    });
            });
    }
    ...
    e("[data-bg-src]").length > 0 &&
        ...
        e("[data-mask-src]").length > 0 &&
            e("[data-mask-src]").each(function () {
                ...
                e(this).css({ "mask-image": "url(" + t + ")", "-webkit-mask-image": "url(" + t + ")" }),
                ...
                .fail(function (e) {
                    u.removeClass("success"),
                        ...
                        "" !== e.responseText
                            ...
                            : u.html("Oops! An error occured and your message could not be sent.");
                });
    }
    if (
        ...
        gsap.registerPlugin(ScrollTrigger),
            document.querySelectorAll(".th-anim").forEach((e) => {
                ...
                a.set(e, { autoAlpha: 1 }),
                    ...
                    a.from(t, 1.5, { xPercent: 100, scale: 1.3, delay: -1.5, ease: Power2.out });
            });
    }
    function h(e) {
    ...
    e.fn.sectionPosition = function (t, a) {
        e(this).each(function () {
            ...
            (s = Math.floor(l.height() / 2)),
                ...
                "top-half" === n
                    ? (e(i).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px"))
                    : "bottom-half" === n &&
                      (e(i).css("padding-top", o + s + "px"), l.css("margin-bottom", "-" + s + "px"));
        });
    };
    function m() {
