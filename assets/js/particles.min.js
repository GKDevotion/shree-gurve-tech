            ...
            for (var e = 0; e < i.particles.array.length; e++) {
                ...
                if (
                    (i.particles.opacity.anim.enable &&
                        (1 == t.opacity_status
                            ...
                            : (t.opacity <= i.particles.opacity.anim.opacity_min && (t.opacity_status = !0),
                              (t.opacity -= t.vo)),
                ...
                switch (
                    (t.x - t.radius > i.canvas.w
                        ...
                        : t.x + t.radius < 0 && ((t.x = s.x_right), (t.y = Math.random() * i.canvas.h)),
                    t.y - t.radius > i.canvas.h
                        ? ((t.y = s.y_top), (t.x = Math.random() * i.canvas.w))
                        : t.y + t.radius < 0 && ((t.y = s.y_bottom), (t.x = Math.random() * i.canvas.w)),
        ...
        (i.fn.modes.bubbleParticle = function (e) {
            if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
                ...
                function p(t, a, s, n, r) {
                    if (t != a)
                        if (i.tmp.bubble_duration_end)
                            null != s &&
                                ((o = t + (t - (n - (v * (n - t)) / i.interactivity.modes.bubble.duration))),
                ...
                i.tmp.bubble_clicking &&
                    (p(i.interactivity.modes.bubble.size, i.particles.size.value, e.radius_bubble, e.radius, "size"),
                    p(
        ...
        (i.fn.modes.repulseParticle = function (e) {
            if (
                ...
                var t = e.x - i.interactivity.mouse.pos_x,
                    ...
                    n = { x: t / s, y: a / s },
                    r = clamp(
                        (1 / (o = i.interactivity.modes.repulse.distance)) * (-1 * Math.pow(s / o, 2) + 1) * o * 100,
                        0,
                        50
                    ),
